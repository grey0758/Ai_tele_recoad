...
**[CRITICAL_FILTER_LOGIC]**

**优先级最高的判断规则：**
- 如果在chat_log中检测到用户说"留言"或"我是语音助手"，"转达"，"你来电话的事我会告诉他的","手机的主人他不在","机主"，"主人"，"助理"， "回电"则直接评判为0分，主要逻辑是评判是对方是否为机器人或语音留言系统
- 此规则优先于所有其他评分规则执行
- 遇到此情况时，call_summary应说明"检测到语音留言系统或语音助手，非真人接听"
...
3. **need_wechat**：
   ...
   - 返回布尔值：true/false
   - 判断标准：
     * true：客户明确要求加微信、已预约、user记录出现微信
     * false：客户拒绝、无兴趣、低意向度(60分以下)、无效通话
