...
class ResponseBuilder:
    ...
    @staticmethod
    def paginated(items: List[T], page: int, page_size: int, total: int, message: str = "获取数据成功") -> ResponseData[PaginatedData[T]]:
        """构造分页响应"""
        ...
        return ResponseData[PaginatedData[T]](code=200, data=paginated_data, message=message)
